...
$medida_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
if ($medida_id === 0) {
...
<body>
    ...
    <div class="container">
        ...
        <form action="atualiza_medida.php" method="POST">
            <input type="hidden" name="produto_id" value="<?= $medida_id ?>">
            
            <div>
                <label for="nome">Nome do Item:</label>
                <input type="text" id="nome" name="nome" value="<?= htmlspecialchars($medida['nome']) ?>" required>
            </div>
            ...
            <div>
                ...
                <select id="tipo" name="tipo" required>
                    ...
                    foreach ($tipos as $tipo) {
                        $selected = ($tipo === $medida['tipo']) ? 'selected' : '';
